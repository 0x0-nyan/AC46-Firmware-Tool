...
WARNING:<br>
This procedure might blick your device completely if not done properly, or there are bad bootloader, SDRAM.<br>
Make sure that there are no JieLi devices are connected via USB, unless if you want to reflash.<br>
Reflashing is actually not been tested yet as devices with AC46 are rare these days.<br>
...
Finally, remove .txt from "Repacker.bat.txt" and run it. You'll get a jl_ac46.bin and jl_bt46.bfu files.
